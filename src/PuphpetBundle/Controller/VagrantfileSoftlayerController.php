...
class VagrantfileSoftlayerController extends Controller
{
    ...
    {
        return $this->render('PuphpetBundle:vagrantfile-softlayer:form.html.twig', [
            'data' => $data,
        ]);
    }
    ...
    {
        return $this->render('PuphpetBundle:vagrantfile-softlayer/sections:machine.html.twig', [
    ...
    {
        return $this->render('PuphpetBundle:vagrantfile-softlayer/sections:synced-folder.html.twig', [
