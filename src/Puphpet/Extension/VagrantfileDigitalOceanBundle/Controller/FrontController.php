...
class FrontController extends Controller implements Extension\ControllerInterface
{
    ...
    {
        return $this->render('PuphpetMainBundle:extensions/vagrantfile-digitalocean:form.html.twig', [
            'data' => $data,
        ]);
    }
    ...
    {
        return $this->render('PuphpetMainBundle:extensions/vagrantfile-digitalocean/sections:synced-folder.html.twig', [
