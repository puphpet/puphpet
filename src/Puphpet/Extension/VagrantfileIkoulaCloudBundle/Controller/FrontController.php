...
class FrontController extends Controller implements Extension\ControllerInterface
{
    ...
    {
        return $this->render('PuphpetMainBundle:extensions/vagrantfile-ikoula:form.html.twig', [
            'data' => $data,
        ]);
    }
    ...
    {
        return $this->render('PuphpetMainBundle:extensions/vagrantfile-ikoula/sections:synced-folder.html.twig', [
